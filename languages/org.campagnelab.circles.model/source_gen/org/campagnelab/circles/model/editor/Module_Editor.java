...
public class Module_Editor extends DefaultNodeEditor {
  ...
  private EditorCell createCollection_iuuvkg_a(EditorContext editorContext, SNode node) {
    ...
    editorCell.addEditorCell(this.createRefNodeList_iuuvkg_c0(editorContext, node));
    return editorCell;
  }
  private EditorCell createConstant_iuuvkg_a0(EditorContext editorContext, SNode node) {
    EditorCell_Constant editorCell = new EditorCell_Constant(editorContext, node, "abstract module");
  ...
  private EditorCell createRefNodeList_iuuvkg_c0(EditorContext editorContext, SNode node) {
    AbstractCellListHandler handler = new Module_Editor.modelsListHandler_iuuvkg_c0(node, "models", editorContext);
    EditorCell_Collection editorCell = handler.createCells(editorContext, new CellLayout_Indent(), false);
    editorCell.setCellId("refNodeList_models");
    editorCell.setRole(handler.getElementRole());
    return editorCell;
  }
  private static class modelsListHandler_iuuvkg_c0 extends RefNodeListHandler {
    public modelsListHandler_iuuvkg_c0(SNode ownerNode, String childRole, EditorContext context) {
