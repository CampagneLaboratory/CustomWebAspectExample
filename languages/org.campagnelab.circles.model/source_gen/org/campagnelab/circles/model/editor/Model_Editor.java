...
public class Model_Editor extends DefaultNodeEditor {
  ...
  private EditorCell createCollection_pyq9q9_a(EditorContext editorContext, SNode node) {
    ...
    editorCell.addEditorCell(this.createConstant_pyq9q9_d0(editorContext, node));
    editorCell.addEditorCell(this.createConstant_pyq9q9_e0(editorContext, node));
    editorCell.addEditorCell(this.createRefNodeList_pyq9q9_f0(editorContext, node));
    editorCell.addEditorCell(this.createConstant_pyq9q9_g0(editorContext, node));
  ...
  private EditorCell createConstant_pyq9q9_d0(EditorContext editorContext, SNode node) {
  ...
  private EditorCell createConstant_pyq9q9_e0(EditorContext editorContext, SNode node) {
    ...
    Style style = new StyleImpl();
    style.set(StyleAttributes.PUNCTUATION_LEFT, 0, true);
    style.set(StyleAttributes.MATCHING_LABEL, 0, "paren-nodes");
    style.set(StyleAttributes.PUNCTUATION_RIGHT, 0, true);
    editorCell.getStyle().putAll(style);
    editorCell.setDefaultText("");
    return editorCell;
  }
  private EditorCell createRefNodeList_pyq9q9_f0(EditorContext editorContext, SNode node) {
    AbstractCellListHandler handler = new Model_Editor.nodesListHandler_pyq9q9_f0(node, "nodes", editorContext);
    EditorCell_Collection editorCell = handler.createCells(editorContext, new CellLayout_Indent(), false);
    editorCell.setCellId("refNodeList_nodes");
    editorCell.setRole(handler.getElementRole());
    return editorCell;
  }
  private static class nodesListHandler_pyq9q9_f0 extends RefNodeListHandler {
    public nodesListHandler_pyq9q9_f0(SNode ownerNode, String childRole, EditorContext context) {
  ...
  private EditorCell createConstant_pyq9q9_g0(EditorContext editorContext, SNode node) {
    EditorCell_Constant editorCell = new EditorCell_Constant(editorContext, node, ")");
