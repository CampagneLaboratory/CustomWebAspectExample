...
public class TestExportScopePublic {
  @Test
  public void testToModel() throws Exception {
    ...
    db.open("admin", "admin");
    try {
      String sql = "select * from Module".replaceAll("Module", "jetbrains_C_mps_C_lang_C_core_C_structure_C_ExportScopePublic");
      ...
      ExportScopePublic_Bean bean = ExportScopePublic_DbToPojoHelper.transform((ODocument) result.get(0));
      Assert.assertNotNull(bean);
      ExportScopePublic_WebModel webModel = ExportScopePublicToWebModel.transform(bean, null);
