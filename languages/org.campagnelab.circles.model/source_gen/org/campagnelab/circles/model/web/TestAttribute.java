...
public class TestAttribute {
  ...
  public void testToModel() throws Exception {
    ...
    db.open("admin", "admin");
    try {
      String sql = "select * from Module".replaceAll("Module", "jetbrains_C_mps_C_lang_C_core_C_structure_C_Attribute");
      ...
      Attribute_Bean bean = Attribute_DbToPojoHelper.transform((ODocument) result.get(0));
      Assert.assertNotNull(bean);
      Attribute_WebModel webModel = AttributeToWebModel.transform(bean, null);
