...
public class TestRootRef {
  ...
  public void testToModel() throws Exception {
    ...
    db.open("admin", "admin");
    try {
      String sql = "select * from Module".replaceAll("Module", "org_C_campagnelab_C_circles_C_model_C_structure_C_RootRef");
      ...
      RootRef_Bean bean = RootRef_DbToPojoHelper.transform((ODocument) result.get(0));
      Assert.assertNotNull(bean);
      RootRef_WebModel webModel = RootRefToWebModel.transform(bean, null);
