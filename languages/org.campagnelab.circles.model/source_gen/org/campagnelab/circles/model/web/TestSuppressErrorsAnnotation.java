...
public class TestSuppressErrorsAnnotation {
  @Test
  public void testToModel() throws Exception {
    ...
    db.open("admin", "admin");
    try {
      String sql = "select * from Module".replaceAll("Module", "jetbrains_C_mps_C_lang_C_core_C_structure_C_SuppressErrorsAnnotation");
      ...
      SuppressErrorsAnnotation_Bean bean = SuppressErrorsAnnotation_DbToPojoHelper.transform((ODocument) result.get(0));
      Assert.assertNotNull(bean);
      SuppressErrorsAnnotation_WebModel webModel = SuppressErrorsAnnotationToWebModel.transform(bean, null);
