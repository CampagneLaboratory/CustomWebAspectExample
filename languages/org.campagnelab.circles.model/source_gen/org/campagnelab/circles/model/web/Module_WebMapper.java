...
public class Module_WebMapper extends Mapper<Module_WebModel, Module_WebView> {

  public Module_WebMapper(Module_WebModel model) {
    super(model, new Module_WebView());
