...
public class TestChildAttribute {
  @Test
  public void testToModel() throws Exception {
    ...
    db.open("admin", "admin");
    try {
      String sql = "select * from Module".replaceAll("Module", "jetbrains_C_mps_C_lang_C_core_C_structure_C_ChildAttribute");
      ...
      ChildAttribute_Bean bean = ChildAttribute_DbToPojoHelper.transform((ODocument) result.get(0));
      Assert.assertNotNull(bean);
      ChildAttribute_WebModel webModel = ChildAttributeToWebModel.transform(bean, null);
