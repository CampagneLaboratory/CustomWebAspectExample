...
public class TestExportScopeModule {
  @Test
  public void testToModel() throws Exception {
    ...
    db.open("admin", "admin");
    try {
      String sql = "select * from Module".replaceAll("Module", "jetbrains_C_mps_C_lang_C_core_C_structure_C_ExportScopeModule");
      ...
      ExportScopeModule_Bean bean = ExportScopeModule_DbToPojoHelper.transform((ODocument) result.get(0));
      Assert.assertNotNull(bean);
      ExportScopeModule_WebModel webModel = ExportScopeModuleToWebModel.transform(bean, null);
