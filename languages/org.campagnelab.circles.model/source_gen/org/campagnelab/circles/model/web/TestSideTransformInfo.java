...
public class TestSideTransformInfo {
  @Test
  public void testToModel() throws Exception {
    ...
    db.open("admin", "admin");
    try {
      String sql = "select * from Module".replaceAll("Module", "jetbrains_C_mps_C_lang_C_core_C_structure_C_SideTransformInfo");
      ...
      SideTransformInfo_Bean bean = SideTransformInfo_DbToPojoHelper.transform((ODocument) result.get(0));
      Assert.assertNotNull(bean);
      SideTransformInfo_WebModel webModel = SideTransformInfoToWebModel.transform(bean, null);
