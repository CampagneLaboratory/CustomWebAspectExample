...
public class TestPropertyAttribute {
  ...
  public void testToModel() throws Exception {
    ...
    db.open("admin", "admin");
    try {
      String sql = "select * from Module".replaceAll("Module", "jetbrains_C_mps_C_lang_C_core_C_structure_C_PropertyAttribute");
      ...
      PropertyAttribute_Bean bean = PropertyAttribute_DbToPojoHelper.transform((ODocument) result.get(0));
      Assert.assertNotNull(bean);
      PropertyAttribute_WebModel webModel = PropertyAttributeToWebModel.transform(bean, null);
