...
public class TestModel {
  ...
  public void testToModel() throws Exception {
    ...
    db.open("admin", "admin");
    try {
      String sql = "select * from Module".replaceAll("Module", "org_C_campagnelab_C_circles_C_model_C_structure_C_Model");
      ...
      Model_Bean bean = Model_DbToPojoHelper.transform((ODocument) result.get(0));
      Assert.assertNotNull(bean);
      Model_WebModel webModel = ModelToWebModel.transform(bean, null);
