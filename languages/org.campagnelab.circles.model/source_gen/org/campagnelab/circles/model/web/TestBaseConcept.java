...
public class TestBaseConcept {
  ...
  public void testToModel() throws Exception {
    ...
    db.open("admin", "admin");
    try {
      String sql = "select * from Module".replaceAll("Module", "jetbrains_C_mps_C_lang_C_core_C_structure_C_BaseConcept");
      ...
      BaseConcept_Bean bean = BaseConcept_DbToPojoHelper.transform((ODocument) result.get(0));
      Assert.assertNotNull(bean);
      BaseConcept_WebModel webModel = BaseConceptToWebModel.transform(bean, null);
