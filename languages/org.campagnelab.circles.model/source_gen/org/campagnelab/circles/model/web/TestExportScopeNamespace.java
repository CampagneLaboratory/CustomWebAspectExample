...
public class TestExportScopeNamespace {
  @Test
  public void testToModel() throws Exception {
    ...
    db.open("admin", "admin");
    try {
      String sql = "select * from Module".replaceAll("Module", "jetbrains_C_mps_C_lang_C_core_C_structure_C_ExportScopeNamespace");
      ...
      ExportScopeNamespace_Bean bean = ExportScopeNamespace_DbToPojoHelper.transform((ODocument) result.get(0));
      Assert.assertNotNull(bean);
      ExportScopeNamespace_WebModel webModel = ExportScopeNamespaceToWebModel.transform(bean, null);
