...
public class Language_WebMapper extends Mapper<Language_WebModel, Language_WebView> {

  public Language_WebMapper(Language_WebModel model) {
    super(model, new Language_WebView());
