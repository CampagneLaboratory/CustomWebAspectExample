...
public class TestProject {
  ...
  public void testToModel() throws Exception {
    ...
    db.open("admin", "admin");
    try {
      String sql = "select * from Module".replaceAll("Module", "org_C_campagnelab_C_circles_C_model_C_structure_C_Project");
      ...
      Project_Bean bean = Project_DbToPojoHelper.transform((ODocument) result.get(0));
      Assert.assertNotNull(bean);
      Project_WebModel webModel = ProjectToWebModel.transform(bean, null);
