...
public class TestExportScope {
  ...
  public void testToModel() throws Exception {
    ...
    db.open("admin", "admin");
    try {
      String sql = "select * from Module".replaceAll("Module", "jetbrains_C_mps_C_lang_C_core_C_structure_C_ExportScope");
      ...
      ExportScope_Bean bean = ExportScope_DbToPojoHelper.transform((ODocument) result.get(0));
      Assert.assertNotNull(bean);
      ExportScope_WebModel webModel = ExportScopeToWebModel.transform(bean, null);
