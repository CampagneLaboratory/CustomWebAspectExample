...
public class TestSolution {
  ...
  public void testToModel() throws Exception {
    ...
    db.open("admin", "admin");
    try {
      String sql = "select * from Module".replaceAll("Module", "org_C_campagnelab_C_circles_C_model_C_structure_C_Solution");
      ...
      Solution_Bean bean = Solution_DbToPojoHelper.transform((ODocument) result.get(0));
      Assert.assertNotNull(bean);
      Solution_WebModel webModel = SolutionToWebModel.transform(bean, null);
