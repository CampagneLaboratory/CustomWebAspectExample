...
public class TestRoot {
  ...
  public void testToModel() throws Exception {
    ...
    db.open("admin", "admin");
    try {
      String sql = "select * from Module".replaceAll("Module", "org_C_campagnelab_C_circles_C_model_C_structure_C_Root");
      ...
      Root_Bean bean = Root_DbToPojoHelper.transform((ODocument) result.get(0));
      Assert.assertNotNull(bean);
      Root_WebModel webModel = RootToWebModel.transform(bean, null);
