...
public class TestSearchNodes {
  ...
  public void testToModel() throws Exception {
    ...
    db.open("admin", "admin");
    try {
      String sql = "select * from Module".replaceAll("Module", "org_C_campagnelab_C_circles_C_model_C_structure_C_SearchNodes");
      ...
      SearchNodes_Bean bean = SearchNodes_DbToPojoHelper.transform((ODocument) result.get(0));
      Assert.assertNotNull(bean);
      SearchNodes_WebModel webModel = SearchNodesToWebModel.transform(bean, null);
