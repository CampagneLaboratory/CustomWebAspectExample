...
public class TestLinkAttribute {
  @Test
  public void testToModel() throws Exception {
    ...
    db.open("admin", "admin");
    try {
      String sql = "select * from Module".replaceAll("Module", "jetbrains_C_mps_C_lang_C_core_C_structure_C_LinkAttribute");
      ...
      LinkAttribute_Bean bean = LinkAttribute_DbToPojoHelper.transform((ODocument) result.get(0));
      Assert.assertNotNull(bean);
      LinkAttribute_WebModel webModel = LinkAttributeToWebModel.transform(bean, null);
