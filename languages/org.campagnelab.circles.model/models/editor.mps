...
<model ref="r:3d4b8a25-2cca-4083-ac64-ee80560fc20e(org.campagnelab.circles.model.editor)">
  ...
  <registry>
    ...
    <language id="8c40f9f4-b3bd-42d0-8b65-8e644273493c" name="org.campagnelab.circles.aspect">
      <concept id="5761987585673253147" name="org.campagnelab.circles.aspect.structure.CellModel_Link" flags="ng" index="3Hm0P">
      ...
      <concept id="5597880810753879929" name="org.campagnelab.circles.aspect.structure.TokenValueLink" flags="ng" index="em$m9">
        <reference id="5597880810753879930" name="token" index="em$ma" />
      </concept>
      <concept id="5597880810753879932" name="org.campagnelab.circles.aspect.structure.TokenPropertyValue" flags="ng" index="em$mc">
        <reference id="5597880810753879933" name="property" index="em$md" />
      </concept>
      <concept id="5487921954572064729" name="org.campagnelab.circles.aspect.structure.CellModel_ActionLink" flags="ng" index="1dvdgC">
  ...
  <node concept="24kQdi" id="29x8GeHEHi$">
    ...
    <node concept="3ZW7eb" id="2AOESKYijOR" role="lGtFl">
      <property role="2ripvU" value="1" />
      <property role="TrG5h" value="Circles_SearchNodesEditor-2" />
      <ref role="KZaLW" to="xz77:2AOESKYijNM" resolve="VOLUME_II" />
    </node>
  </node>
  <node concept="24kQdi" id="4QJEJ1435Ds">
    <ref role="1XX52x" to="77ry:4QJEJ1435Di" resolve="RootRef" />
    <node concept="3EZMnI" id="4QJEJ1435Du" role="2wV5jI">
      <node concept="3F0A7n" id="4QJEJ1435D_" role="3EZMnx">
        <ref role="1NtTu8" to="tpck:h0TrG11" resolve="name" />
      </node>
      <node concept="3Hm0P" id="4QJEJ1435DF" role="3EZMnx">
        <property role="3Hlny" value="View" />
        <ref role="3Hln$" to="qkpo:4QJEJ1435DJ" resolve="ViewRoot" />
        <node concept="em$mc" id="4QJEJ1435EE" role="em$m6">
          <ref role="em$ma" to="qkpo:4QJEJ1435DK" resolve="id" />
          <ref role="em$md" to="77ry:4QJEJ1435EG" resolve="id" />
        </node>
      </node>
      <node concept="l2Vlx" id="4QJEJ1435Dx" role="2iSdaV" />
    </node>
  </node>
</model>
