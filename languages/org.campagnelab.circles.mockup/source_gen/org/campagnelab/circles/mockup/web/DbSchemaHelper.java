...
public class DbSchemaHelper {
  ...
  public void dropSchemaForConcepts(String user, String password) {
    ...
    try {
      ...
      dropClass(schema, "org_C_campagnelab_C_circles_C_mockup_C_structure_C_Dashboard");
      dropClass(schema, "jetbrains_C_mps_C_lang_C_core_C_structure_C_BaseConcept");
      dropClass(schema, "org_C_campagnelab_C_circles_C_mockup_C_structure_C_CircleContainer");
      dropClass(schema, "org_C_campagnelab_C_circles_C_mockup_C_structure_C_Circle");
      dropClass(schema, "jetbrains_C_mps_C_lang_C_core_C_structure_C_INamedConcept");
      dropClass(schema, "org_C_campagnelab_C_circles_C_mockup_C_structure_C_AllCirclesInDb");
      dropClass(schema, "org_C_campagnelab_C_circles_C_mockup_C_structure_C_CircleRef");
      dropClass(schema, "org_C_campagnelab_C_circles_C_mockup_C_structure_C_CircleItem");
      dropClass(schema, "org_C_campagnelab_C_circles_C_mockup_C_structure_C_FileItem");
  ...
  public void defineSchemaForConcepts(String user, String password) {
    ...
    try {
      ...
      defineClass(schema, "org_C_campagnelab_C_circles_C_mockup_C_structure_C_Dashboard");
      defineClass(schema, "jetbrains_C_mps_C_lang_C_core_C_structure_C_BaseConcept");
      defineClass(schema, "org_C_campagnelab_C_circles_C_mockup_C_structure_C_CircleContainer");
      defineClass(schema, "org_C_campagnelab_C_circles_C_mockup_C_structure_C_Circle");
      defineClass(schema, "jetbrains_C_mps_C_lang_C_core_C_structure_C_INamedConcept");
      defineClass(schema, "org_C_campagnelab_C_circles_C_mockup_C_structure_C_AllCirclesInDb");
      defineClass(schema, "org_C_campagnelab_C_circles_C_mockup_C_structure_C_CircleRef");
      defineClass(schema, "org_C_campagnelab_C_circles_C_mockup_C_structure_C_CircleItem");
      defineClass(schema, "org_C_campagnelab_C_circles_C_mockup_C_structure_C_FileItem");
      ...
      createSchemaFor(db, MetaAdapterFactory.getConcept(0x3dc3d3d3b034480cL, 0x8b21d7a88903974bL, 0x764e562bb753d688L, "org.campagnelab.circles.mockup.structure.AllCirclesInDb"));
